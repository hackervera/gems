...
module Config
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/ruby-enterprise-1.8.7-2009.10")
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "ruby"
  CONFIG["MANTYPE"] = "doc"
  CONFIG["NROFF"] = "/usr/bin/nroff"
  CONFIG["configure_args"] = " '--prefix=/opt/ruby-enterprise-1.8.7-2009.10' '--enable-mbari-api' 'CFLAGS=-g -Os -fno-strict-aliasing '"
  ...
  CONFIG["CFLAGS"] = "-g -Os -fno-strict-aliasing  $(cflags)"
  CONFIG["CC"] = "gcc"
